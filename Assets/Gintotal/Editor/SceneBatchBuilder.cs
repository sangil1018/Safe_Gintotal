...
public class SceneBatchBuilder : MonoBehaviour
{
    ...
    [MenuItem("Build/Build Scenes to Separate Apps")]
    public static void BuildScenes()
    {
        ...
        foreach (var sceneGUID in sceneGUIDs)
        {
            ...
            else if (sceneFolder != null && !sceneFolder.Contains("Quest"))
            {
            ...
            var buildFileName = sceneName + (buildTarget == BuildTarget.Android ? ".apk" : ".exe");
